...
class OpenRouterAdapter(BaseAdapter):
        ...
        if stream:
            ...
            if response.status_code == 200:
                try:
                    ...
                    response_data["system_fingerprint"] = self._generate_system_fingerprint(model)
            ...
            async with self.client.stream(
                ...
                if response.status_code >= 400:
                    ...
                    try:
                        ...
                        error_message = f'HTTP {response.status_code}: {error_content.decode()}'
                ...
                async for chunk in response.aiter_text():
                    if chunk.strip():
                        ...
                        modified_chunk = self._add_system_fingerprint_to_chunk(chunk, system_fingerprint)
                        yield modified_chunk
        except httpx.TimeoutException as e:
            error_chunk = f'data: {{"error": {{"message": "Request timeout", "code": 408}}}}\n\ndata: [DONE]\n\n'
            yield error_chunk
    ...
    def _add_system_fingerprint_to_chunk(self, chunk: str, system_fingerprint: str) -> str:
            ...
            for line in lines:
                if line.startswith('data: ') and not line.endswith('[DONE]'):
                    ...
                    try:
                        ...
                        if 'object' in chunk_data and chunk_data['object'] == 'chat.completion.chunk':
