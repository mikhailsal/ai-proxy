...
class ModelFileHandler:
    ...
    def get_handler(self, model_name: str) -> logging.FileHandler:
        ...
        clean_model = model_name.replace("/", "_").replace(":", "_").replace("*", "star")
        if not clean_model:
...
def log_request_response(endpoint: str, request_data: Dict[str, Any], 
                        response_data: Dict[str, Any], status_code: int, 
                        latency_ms: float, api_key_hash: str = None):
    """
...
def log_model_usage(original_model: str, mapped_model: str, request_data: Dict[str, Any], 
                   response_data: Dict[str, Any], status_code: int, latency_ms: float,
