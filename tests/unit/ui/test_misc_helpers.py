# New file with helper and edge-case tests
import os
...
def test_iter_all_partitions_skips_non_matching_files(tmp_path, monkeypatch):
    ...
    open(base_dir / "ai_proxy_20250911.db", "w").close()
    open(base_dir / "wrong_prefix_20250912.sqlite3", "w").close()
    monkeypatch.setenv("LOGUI_API_KEYS", "user-key")
